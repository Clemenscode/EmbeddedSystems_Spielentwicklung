...
public class Connection extends Thread {
     ...
     */
    public Connection(String serverName, int port,clientGui cl){
    ...
    private String connect() {
        try {
            ...
            //Objekt zum Empfangen von Nachrichten ueber das Socketobjekt erzeugen
            vomHost= new BufferedReader(new InputStreamReader(s.getInputStream()));
            cl.processNewMessage("Verbindung : " + s);
            return "Verbindung : " + s;
        } catch (Exception e) {
            cl.processNewMessage("Error: Konnte keine Verbindung zum Server herstellen!");
            //e.printStackTrace();
            return "";
        }
    }
   ...
   */
    public String receive() {
        try {
            ...
            cl.processNewMessage(("Verbindung zu " + getRemoteIP() + " " + getLocalPort() + " ist unterbrochen"));
        }
            return null;
    }
 /** 
